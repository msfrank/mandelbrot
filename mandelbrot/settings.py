...
logger = getLogger('mandelbrot.settings')
...
class Settings(Parser):
    ...
    def __init__(self, usage, description, subusage='Available subcommands:', section=None, appname=None, confbase='/etc/mandelbrot/'):
        """
...
class Section(object):
    ...
    def gettimedelta(self, name, default=None):
        if self.name == None or not self._options.has_option(self.name, name):
            return default
