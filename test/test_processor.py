...
class TestProcessor(unittest.TestCase):
    ...
    def test_process_check_and_submit_evaluation(self):
        ...
        processor = mandelbrot.agent.processor.Processor(event_loop, instance, endpoint, executor)
        try:
            event_loop.run_until_complete(asyncio.wait_for(processor.run_forever(), 2.5, loop=event_loop))
